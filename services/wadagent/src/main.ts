...
import type { ChatMessage, WadaAgentRequest } from './types';
import {
  fetchBookingOptions,
    ...
    <div class="frame">
      <div class="card">
        ...
        <div class="messages" id="messages">
          <div class="bubble">
            Hi, I'm WadaAgent. Ask about tours, itinerary ideas, flight timing, or your bookings.
          </div>
          <div id="table"></div>
        </div>
        <div class="composer">
          <form id="chat-form">
            <textarea id="input" placeholder="Ask me about tours, itinerary ideas, flight timing, or your bookings..."></textarea>
...
app.post('/wadagent/chat', async (req, res) => {
  ...
  const messages: ChatMessage[] = [
    ...
    { role: 'system', content: `itinerary_options: ${JSON.stringify(itineraryOptions)}` },
  ];
  ...
  try {
    ...
    return res.json(normalizeAgentPayload(parsed, pricingAdvice, tourOptions, bookingOptions, itineraryOptions));
  } catch (err: any) {
