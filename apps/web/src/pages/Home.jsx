        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {featured.map((item) => (
              ...
              >
                <div className="h-48 w-full rounded-xl bg-gradient-to-br from-[#00D9FF]/30 via-[#ffb703]/20 to-[#ff006e]/30 border border-[#00D9FF]/20 flex items-center justify-center text-xs text-[#e0e0e0]">
                  Photo coming soon
                </div>
