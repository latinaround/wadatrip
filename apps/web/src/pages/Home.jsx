...
function ExperienceCard({ item, tone = 'warm' }) {
  const toneClasses = {
    warm: 'from-[#fff2e7] via-[#fff8f2] to-[#f7fcfb] border-[#f0dac7]',
    aqua: 'from-[#eefbfb] via-[#f8ffff] to-[#fff5ef] border-[#cfeceb]',
  };
      ...
      <div className="page-container space-y-16">
        <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-[28px] border border-[#eadbcf] bg-[#fff8f2] p-6 text-[#0f172a] shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
