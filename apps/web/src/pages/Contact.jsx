        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="md:col-span-1">
              <div className="page-card p-0 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* Email */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-[#a0a0a0] mb-1">{t('contact.email')}</h4>
                    <p className="text-white">info@wadatrip.com</p>
                  </div>
                  
                  {/* Phone */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-[#a0a0a0] mb-1">{t('contact.phone')}</h4>
                    <p className="text-white">+1 (555) 123-4567</p>
                  </div>
                  
                  {/* Address */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-[#a0a0a0] mb-1">{t('contact.address')}</h4>
                  ...
                  {/* Social Media */}
                  <div>
                    <h4 className="text-sm font-medium text-[#a0a0a0] mb-3">{t('contact.social')}</h4>
                    <div className="flex space-x-4">
                      <a href="#" className="text-[#a0a0a0] hover:text-[#00D9FF] transition-colors">
                ...
                <div className="p-6">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      {/* Subject */}
                      <div>
                        <label htmlFor="subject" className="block text-sm font-medium text-[#e0e0e0] mb-1">
          ...
          <div className="page-card p-0 overflow-hidden mb-12">
            ...
            <div className="p-6">
              ...
              <div className="h-96 bg-[#1a1f3a] rounded-md flex items-center justify-center">
                <p className="text-[#a0a0a0]">{t('contact.map_placeholder')}</p>
              </div>
            </div>
          </div>
        </div>
